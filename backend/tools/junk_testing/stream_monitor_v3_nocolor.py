    ...
    def peak_bars(self, screen, url=''):
        ...
        for i in self.ffmpeg_peak_level():
            ...
            if i['peak_ch1'] != '-inf':
                ...
                screen.addstr(2, len(str_0), bar_yellow)
                screen.addstr(2, len(str_0) + len(bar_yellow), bar_green)
                screen.addstr(2, len(str_0) + len(bar_yellow) + len(bar_green), bar_red)
            ...
            if i['peak_ch2'] != '-inf':
                ...
                screen.addstr(3, len(str_0), bar_yellow)
                screen.addstr(3, len(str_0) + len(bar_yellow), bar_green)
                screen.addstr(3, len(str_0) + len(bar_yellow) + len(bar_green), bar_red)
